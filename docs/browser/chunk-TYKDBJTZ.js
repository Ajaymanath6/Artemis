...
var AppHeaderComponent = class _AppHeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppHeaderComponent, selectors: [["app-header"]], inputs: { showUserProfile: "showUserProfile", showCollapseButton: "showCollapseButton", projectName: "projectName", searchQuery: "searchQuery" }, outputs: { collapseToggle: "collapseToggle", projectClick: "projectClick", searchQueryClick: "searchQueryClick" }, decls: 10, vars: 9, consts: [[1, "bg-white", "sticky", "top-0", "z-50"], [1, "max-w-7xl", "mx-auto", "px-4", "sm:px-6", "lg:px-8"], [1, "flex", "items-center", "justify-between", "h-16"], [1, "flex", "items-center", "space-x-4"], ["class", "p-2 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none", 3, "click", 4, "ngIf"], ["class", "flex items-center space-x-2", 4, "ngIf"], ["class", "flex items-center space-x-4", 4, "ngIf"], ["class", "flex items-center space-x-2 px-4 py-2 border border-stroke-strong rounded-lg text-text-strong hover:bg-fill focus:outline-none transition-colors", 3, "click", 4, "ngIf"], ["class", "fixed inset-0 z-40", 3, "click", 4, "ngIf"], [1, "p-2", "rounded-lg", "hover:bg-gray-50", "transition-colors", "focus:outline-none", 3, "click"], [1, "ri-layout-left-line", "text-lg", 2, "color", "#9CA3AF"], [1, "flex", "items-center", "space-x-2"], ["class", "text-gray-600 hover:text-brand transition-colors focus:outline-none font-medium truncate", 3, "click", 4, "ngIf"], ["class", "text-gray-400 font-medium", 4, "ngIf"], ["class", "text-gray-900 hover:text-brand transition-colors focus:outline-none font-normal truncate", 3, "click", 4, "ngIf"], [1, "text-gray-600", "hover:text-brand", "transition-colors", "focus:outline-none", "font-medium", "truncate", 3, "click"], [1, "text-gray-400", "font-medium"], [1, "text-gray-900", "hover:text-brand", "transition-colors", "focus:outline-none", "font-normal", "truncate", 3, "click"], [1, "text-gray-500", "text-sm", "font-normal"], [1, "relative"], [1, "flex", "items-center", "space-x-3", "p-2", "rounded-lg", "hover:bg-gray-50", "transition-colors", 3, "click"], [1, "w-8", "h-8", "bg-brand", "rounded-full", "flex", "items-center", "justify-center"], ["name", "user", "weight", "bold", "color", "white", 3, "size"], [1, "hidden", "md:block", "text-left"], [1, "text-sm", "font-medium", "text-text-strong"], [1, "text-xs", "text-text-weak"], [1, "ri-arrow-down-s-line", "hidden", "md:block", 2, "color", "#353D59", "font-size", "14px"], ["class", "absolute right-0 mt-2 w-48 bg-white rounded-lg border border-stroke-weak z-50", 4, "ngIf"], [1, "absolute", "right-0", "mt-2", "w-48", "bg-white", "rounded-lg", "border", "border-stroke-weak", "z-50"], [1, "py-2"], ["href", "#", 1, "flex", "items-center", "px-4", "py-2", "text-sm", "text-text-strong", "hover:bg-fill"], ["name", "user", "weight", "regular", "color", "currentColor", "className", "mr-3", 3, "size"], ["name", "gear", "weight", "regular", "color", "currentColor", "className", "mr-3", 3, "size"], [1, "my-2", "border-stroke-weak"], [1, "w-full", "flex", "items-center", "px-4", "py-2", "text-sm", "text-text-strong", "hover:bg-fill", 3, "click"], ["name", "sign-out", "weight", "regular", "color", "currentColor", "className", "mr-3", 3, "size"], [1, "flex", "items-center", "space-x-2", "px-4", "py-2", "border", "border-stroke-strong", "rounded-lg", "text-text-strong", "hover:bg-fill", "focus:outline-none", "transition-colors", 3, "click"], ["name", "question", "weight", "bold", "color", "currentColor", 3, "size"], [1, "text-sm", "font-medium"], [1, "fixed", "inset-0", "z-40", 3, "click"]], template: function AppHeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-TYKDBJTZ.js.map
