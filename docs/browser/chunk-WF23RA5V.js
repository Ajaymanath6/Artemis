...
function SideNavComponent_li_8_i_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("color", ctx_r2.isActiveRoute(item_r2.route || "") ? "#146B85" : "#9CA3AF");
  }
}
function SideNavComponent_li_8_ul_7_li_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("color", ctx_r2.isActiveRoute(child_r5.route || "") ? "#146B85" : "#9CA3AF");
    \u0275\u0275advance(2);
...
function CasesComponent_div_9_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 12);
    \u0275\u0275element(2, "div", 13)(3, "div", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 15);
    \u0275\u0275element(5, "div", 16)(6, "div", 17)(7, "div", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 19)(9, "div", 20);
    \u0275\u0275element(10, "div", 21)(11, "div", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 20);
    \u0275\u0275element(13, "div", 23)(14, "div", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 19)(16, "div", 20);
    \u0275\u0275element(17, "div", 25)(18, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 20);
    \u0275\u0275element(20, "div", 27)(21, "div", 28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 29);
    \u0275\u0275element(23, "div", 30)(24, "div", 31)(25, "div", 32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "div");
    \u0275\u0275element(27, "div", 33)(28, "div", 31)(29, "div", 34);
    \u0275\u0275elementEnd()();
  }
}
function CasesComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CasesComponent_div_9_div_1_Template, 30, 0, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.skeletonCards);
  }
}
var CasesComponent = class _CasesComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CasesComponent, selectors: [["app-cases"]], decls: 10, vars: 8, consts: [[1, "min-h-screen"], [3, "itemClick", "sidebarToggle", "isCollapsed"], [1, "flex", "flex-col", "bg-cases-page", "min-h-screen"], [3, "collapseToggle", "showUserProfile", "showCollapseButton"], [1, "flex-1", "overflow-y-auto"], [1, "max-w-7xl", "mx-auto", "px-4", "sm:px-6", "lg:px-8", "py-8"], [1, "mb-8"], [3, "search"], ["class", "space-y-4", 4, "ngIf"], [1, "space-y-4"], ["class", "bg-white rounded-lg border border-gray-200 p-6 animate-pulse", 4, "ngFor", "ngForOf"], [1, "bg-white", "rounded-lg", "border", "border-gray-200", "p-6", "animate-pulse"], [1, "flex", "items-center", "mb-4"], [1, "w-6", "h-6", "bg-gray-300", "rounded-full", "mr-3"], [1, "h-6", "bg-gray-300", "rounded", "w-1\\/3"], [1, "flex", "items-center", "space-x-2", "mb-3"], [1, "h-6", "bg-gray-200", "rounded-full", "px-3", "py-1", "w-16"], [1, "h-6", "bg-gray-200", "rounded-full", "px-3", "py-1", "w-20"], [1, "h-6", "bg-gray-200", "rounded-full", "px-3", "py-1", "w-24"], [1, "flex", "items-center", "space-x-4", "mb-3"], [1, "flex", "items-center", "space-x-2"], [1, "h-5", "bg-gray-200", "rounded-full", "w-12"], [1, "h-5", "bg-gray-300", "rounded", "w-24"], [1, "h-5", "bg-gray-200", "rounded-full", "w-16"], [1, "h-5", "bg-gray-300", "rounded", "w-32"], [1, "h-5", "bg-gray-200", "rounded-full", "w-14"], [1, "h-5", "bg-gray-300", "rounded", "w-28"], [1, "h-5", "bg-gray-200", "rounded-full", "w-18"], [1, "h-5", "bg-gray-300", "rounded", "w-36"], [1, "mb-2"], [1, "h-5", "bg-gray-200", "rounded-full", "w-20", "mb-2"], [1, "h-4", "bg-gray-300", "rounded", "w-full"], [1, "h-4", "bg-gray-300", "rounded", "w-3\\/4", "mt-1"], [1, "h-5", "bg-gray-200", "rounded-full", "w-24", "mb-2"], [1, "h-4", "bg-gray-300", "rounded", "w-2\\/3", "mt-1"]], template: function CasesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(9, CasesComponent_div_9_Template, 2, 1, "div", 8);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
      ...
      \u0275\u0275advance();
      \u0275\u0275property("showUserProfile", true)("showCollapseButton", ctx.isSidebarCollapsed);
      \u0275\u0275advance(6);
...
//# sourceMappingURL=chunk-WF23RA5V.js.map
