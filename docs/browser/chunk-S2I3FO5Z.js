      ...
      (viewModeChange)="toggleViewMode($event)">
        <!-- Cases Content Area -->
          ...
          <div *ngIf="isSearching">
              ...
              <!-- Case Title Row -->
              <div class="flex items-start space-x-3 case-card-title">
